    ...
    <div class="container padding-bottom-3x mb-1 checkut-page">
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="checkoutBilling" action="{{ route('front.checkout.store') }}" method="POST">
                            ...
                            @include('includes.checkout-experience-fields')
                            ...
                            <div class="d-flex justify-content-between paddin-top-1x mt-4">
                                <a class="btn btn-luxury btn-sm" href="{{ route('front.cart') }}"><span
                                        class="hidden-xs-down"><i
                                            class="icon-arrow-left"></i>{{ __('Back To Cart') }}</span></a>
                                @if ($setting->is_privacy_trams == 1)
                                    <button disabled id="continue__button" class="btn btn-luxury  btn-sm"
                                        type="button"><span class="hidden-xs-down">{{ __('Continue') }}</span><i
                                            class="icon-arrow-right"></i></button>
                                @else
                                    <button class="btn btn-luxury btn-sm" type="submit"><span
            ...
            <div class="col-xl-3 col-lg-4">
                @include('includes.checkout-emi-plans')
