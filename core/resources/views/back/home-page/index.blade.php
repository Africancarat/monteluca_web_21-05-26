            ...
            <div class="row">
                <div class="col-5 col-md-3">
                    <div class="nav flex-column nav-pills nav-secondary" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" id="v-pills-t1-tab" data-toggle="pill" href="#v-pills-t1" role="tab" aria-controls="v-pills-t1" aria-selected="false">{{ __('5 column banner First') }}</a>
                        <a class="nav-link" id="v-pills-split-tab" data-toggle="pill" href="#v-pills-split" role="tab" aria-controls="v-pills-split" aria-selected="false">{{ __('Full width split banner') }}</a>
                        ...
                        <a class="nav-link" id="v-pills-t5-tab" data-toggle="pill" href="#v-pills-t5" role="tab" aria-controls="v-pills-t5" aria-selected="false">{{ __('Right side image banner Second') }}</a>
                ...
                <div class="col-7 col-md-9">
                    <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <form class="admin-form" action="{{route('back.first.banner.update')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    ...
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Square 1:1 recommended (e.g. 600×600) for the five-column strip.') }}</span>
                                        </div>
                                        <div class="form-group position-relative">
                                            <label class="file">
                                                <input type="file"  accept="image/*"  class="upload-photo" name="img1" id="file"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    ...
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Square 1:1 recommended (e.g. 600×600).') }}</span>
                                        </div>
                                        <div class="form-group position-relative">
                                            <label class="file">
                                                <input type="file"  accept="image/*"  class="upload-photo" name="img2" id="file"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($first_banner['img4']) ? url('/core/public/storage/images/'.$first_banner['img4']) : url('/core/public/storage/images/'.$first_banner['img1']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Square 1:1 recommended (e.g. 600×600).') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="name">{{ __('Image 5') }} *</label>
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($first_banner['img5']) ? url('/core/public/storage/images/'.$first_banner['img5']) : url('/core/public/storage/images/'.$first_banner['img1']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Square 1:1 recommended (e.g. 600×600).') }}</span>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-split" role="tabpanel" aria-labelledby="v-pills-split-tab">
                            @php $sp = $split_path_banner ?? []; @endphp
                            <form class="admin-form" action="{{ route('back.split.path.banner.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <p class="text-muted small">{{ __('Shown on Theme 3 between the category strip and Special Pick when enabled under Settings → Section.') }}</p>

                                <div class="form-group">
                                    <label>{{ __('Background colour (hex)') }}</label>
                                    <input type="text" name="bg_color" class="form-control" maxlength="32"
                                        placeholder="#F7F5F0" value="{{ $sp['bg_color'] ?? '#F7F5F0' }}">
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Background image') }} <span class="text-muted">({{ __('optional; sits under text & PNG') }})</span></label>
                                    <br>
                                    <img class="admin-img" style="max-height:120px;object-fit:contain;background:#eee;"
                                        src="{{ !empty($sp['bg_image']) ? url('/core/public/storage/images/'.$sp['bg_image']) : url('/core/public/storage/images/placeholder.png') }}"
                                        alt="">
                                    <div class="form-group position-relative mt-2">
                                        <label class="file">
                                            <input type="file" accept="image/*" class="upload-photo" name="bg_image">
                                            <span class="file-custom text-left">{{ __('Upload background...') }}</span>
                                        </label>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Foreground / cutout image (PNG with transparency recommended)') }} *</label>
                                    <br>
                                    <img class="admin-img" style="max-height:160px;object-fit:contain;background:repeating-conic-gradient(#ddd 0% 25%, #fff 0% 50%) 50% / 16px 16px;"
                                        src="{{ !empty($sp['fg_image']) ? url('/core/public/storage/images/'.$sp['fg_image']) : url('/core/public/storage/images/placeholder.png') }}"
                                        alt="">
                                    <div class="form-group position-relative mt-2">
                                        <label class="file">
                                            <input type="file" accept="image/*" class="upload-photo" name="fg_image">
                                            <span class="file-custom text-left">{{ __('Upload cutout...') }}</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <hr>
                                <div class="form-group">
                                    <label>{{ __('Eyebrow / kicker') }}</label>
                                    <input type="text" name="kicker" class="form-control" maxlength="255"
                                        value="{{ $sp['kicker'] ?? '' }}" placeholder="{{ __('DESIGN YOUR OWN') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('Headline') }}</label>
                                    <input type="text" name="headline" class="form-control" maxlength="255"
                                        value="{{ $sp['headline'] ?? '' }}" placeholder="{{ __('ENGAGEMENT RING') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('Body text') }}</label>
                                    <textarea name="body" class="form-control" rows="3" maxlength="2000" placeholder="{{ __('Short paragraph') }}">{{ $sp['body'] ?? '' }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>{{ __('Large watermark text (optional)') }}</label>
                                    <input type="text" name="watermark_text" class="form-control" maxlength="255"
                                        value="{{ $sp['watermark_text'] ?? '' }}" placeholder="{{ __('design your own') }}">
                                </div>

                                <hr>
                                <h6 class="font-weight-bold">{{ __('Primary actions') }}</h6>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label>{{ __('Button 1 label') }}</label>
                                        <input type="text" name="btn1_label" class="form-control" maxlength="200"
                                            value="{{ $sp['btn1_label'] ?? '' }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>{{ __('Button 1 URL') }}</label>
                                        <input type="text" name="btn1_url" class="form-control" maxlength="500"
                                            value="{{ $sp['btn1_url'] ?? '' }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>{{ __('Word between buttons') }}</label>
                                    <input type="text" name="or_label" class="form-control" maxlength="32"
                                        value="{{ $sp['or_label'] ?? 'OR' }}">
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label>{{ __('Button 2 label') }}</label>
                                        <input type="text" name="btn2_label" class="form-control" maxlength="200"
                                            value="{{ $sp['btn2_label'] ?? '' }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>{{ __('Button 2 URL') }}</label>
                                        <input type="text" name="btn2_url" class="form-control" maxlength="500"
                                            value="{{ $sp['btn2_url'] ?? '' }}">
                                    </div>
                                </div>

                                <hr>
                                <h6 class="font-weight-bold">{{ __('Footer line (optional)') }}</h6>
                                <div class="form-group">
                                    <label>{{ __('Text before link') }}</label>
                                    <input type="text" name="foot_prefix" class="form-control" maxlength="255"
                                        value="{{ $sp['foot_prefix'] ?? '' }}" placeholder="{{ __('Make it easy with our') }}">
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label>{{ __('Link text') }}</label>
                                        <input type="text" name="foot_link_text" class="form-control" maxlength="255"
                                            value="{{ $sp['foot_link_text'] ?? '' }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>{{ __('Link URL') }}</label>
                                        <input type="text" name="foot_link_url" class="form-control" maxlength="500"
                                            value="{{ $sp['foot_link_url'] ?? '' }}">
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-t5" role="tabpanel" aria-labelledby="v-pills-t5-tab">
                            <form class="admin-form" action="{{route('back.secend.banner.update')}}" method="POST" enctype="multipart/form-data">
                                ...
                                @php
                                    $s2 = $secend_banner ?? [];
                                    $preview = $s2['image'] ?? $s2['img1'] ?? null;
                                @endphp
                                <div class="form-group">
                                    <label>{{ __('Right Side Image') }} *</label>
                                    <br>
                                    <img class="admin-img"
                                        src="{{ $preview ? url('/core/public/storage/images/'.$preview) : url('/core/public/storage/images/placeholder.png') }}"
                                        alt="No Image Found">
                                    <br>
                                    <span class="mt-1">{{ __('Recommended wide image (e.g. 900 x 520).') }}</span>
                                </div>
                                <div class="form-group position-relative">
                                    <label class="file">
                                ...
                                <div class="form-group">
                                    <label for="breadcrumb">{{ __('Breadcrumb') }}</label>
                                    <input type="text" name="breadcrumb" class="form-control" id="breadcrumb"
                                        placeholder="{{ __('Home / Collections /') }}"
                                        value="{{ $s2['breadcrumb'] ?? ($s2['subtitle1'] ?? '') }}">
                                </div>
                                <div class="form-group">
                                    <label for="heading">{{ __('Title') }} *</label>
                                    <input type="text" name="heading" class="form-control" id="heading"
                                        placeholder="{{ __('Real Diamonds. Reimagined.') }}"
                                        value="{{ $s2['heading'] ?? ($s2['title1'] ?? '') }}">
                                </div>
                                <div class="form-group">
                                    <label for="description">{{ __('Description') }}</label>
                                    <textarea name="description" class="form-control" id="description" rows="3"
                                        placeholder="{{ __('Enter Description') }}">{{ $s2['description'] ?? ($s2['subtitle2'] ?? '') }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="bullet_points">{{ __('Bullet List (one per line or use |)') }}</label>
                                    <textarea name="bullet_points" class="form-control" id="bullet_points" rows="4"
                                        placeholder="{{ __('IGI certified|Exceptional cut and clarity|Modern luxury choice') }}">{{ $s2['bullet_points'] ?? ($s2['title2'] ?? '') }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="button_label">{{ __('Button Label') }} *</label>
                                    <input type="text" name="button_label" class="form-control" id="button_label"
                                        placeholder="{{ __('Read the Diamond Guide') }}"
                                        value="{{ $s2['button_label'] ?? ($s2['title3'] ?? '') }}">
                                </div>
                                <div class="form-group">
                                    <label for="button_url">{{ __('Button URL') }} *</label>
                                    <input type="text" name="button_url" class="form-control" id="button_url"
                                        placeholder="{{ __('Enter URL') }}"
                                        value="{{ $s2['button_url'] ?? ($s2['url1'] ?? '') }}">
                                </div>
