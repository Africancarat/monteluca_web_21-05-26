                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <span class="switch-body"></span>
                                                            <span class="switch-text">{{ __('5 column banner First') }}</span>
                                                            </label>
                                                        </div>
                                            ...
                                            <div id="hthree" class="tab-pane"><br>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox" class="switch switch-bootstrap " name="is_t3_split_path_banner" value="1" {{ ($extra_settings->is_t3_split_path_banner ?? 0) == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span class="switch-text">{{ __('Full width split banner (Theme 3)') }}</span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    ...
                                                                    <span class="switch-body"></span>
                                                                    <span class="switch-text">{{ __('Diamond Inspection Section') }}</span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
